...
export const PASSWORD_HISTORY_COL = [
  ...
  export const getFinancialCol = (actionsConfig = {}) => {
    return [
      ...
      { label: "Credit Ref.", key: "credit_ref", dataKey: "ref_sd_id", sortable: true },
      { label: "Partnership", key: "partnership", sortable: true },
      { label: "Balance", key: "balance", dataKey: "balance", sortable: true, format: "currency" },
      { label: "Exposure", key: "bet_balance", dataKey: "bet_balance", sortable: true, format: "currency" },
      { 
        label: "Avail. Bal.", 
        key: "available_balance", 
        dataKey: "balance", 
        sortable: true, 
        format: (row) => new Intl.NumberFormat("en-IN", {
          style: "currency",
          currency: "INR",
      ...
      { label: "Status", key: "status", sortable: true, format: "status" },
      {
        ...
        key: "actions",
        sortable: false,
        actionsConfig: (row) => Object.keys(actionsConfig).map((actionKey) => ({
...
export const BANKING_COL =   [
    ...
    { field: 'Balance', label: 'Balance', sortable: true, format: 'currency', key: 'balance' },
    { field: 'Available D / W', label: 'Available D / W', sortable: true, key: 'availabledw' },
    { field: 'Exposure', label: 'Exposure', key: 'exposure' },
    { field: 'Credit Reference', label: 'Credit Reference', sortable: true, key: 'creditreference' },
